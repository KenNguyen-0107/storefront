...
export class BestBetsService {
   ...
   * @throws ApiError
   */
  public getBestBetCollectionHandler(id?: string, page?: number): CancelablePromise<Array<BestBetCollectionResult>> {
   ...
   * @throws ApiError
   */
  public deleteBestBetCollectionHandler(id: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/api/bestbets/collection/{id}",
      path: {
