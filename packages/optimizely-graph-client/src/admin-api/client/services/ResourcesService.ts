...
export class ResourcesService {
   ...
   * @throws ApiError
   */
  public deleteStopwordHandler(languageRouting?: string, sourceRouting?: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/resources/stopwords",
      query: {
   ...
   * @throws ApiError
   */
  public deleteSynonymHandler(languageRouting?: string, sourceRouting?: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/resources/synonyms",
      query: {
