...
export class DefinitionV3Service {
   ...
   * @throws ApiError
   */
  public getContentV3SourceHandler(id?: string): CancelablePromise<SourceInfoMap> {
   ...
   * @throws ApiError
   */
  public deleteContentV3SourceHandler(id?: string, mode?: DeleteMode): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/api/content/v3/sources",
      query: {
   ...
   * @throws ApiError
   */
  public postContentV3SourceHandler(id: string, requestBody: SourceMetadata): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "POST",
      url: "/api/content/v3/sources",
      query: {
   ...
   * @throws ApiError
   */
  public getContentV3TypeHandler(id: string = "default"): CancelablePromise<ContentSource_V3> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public postContentV3TypeHandler(requestBody: ContentSource_V3, id: string = "default"): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "POST",
      url: "/api/content/v3/types",
      query: {
   ...
   * @throws ApiError
   */
  public putContentV3TypeHandler(requestBody: ContentSource_V3, id: string = "default"): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "PUT",
      url: "/api/content/v3/types",
      query: {
