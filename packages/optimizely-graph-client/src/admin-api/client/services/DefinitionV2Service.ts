...
export class DefinitionV2Service {
   ...
   * @throws ApiError
   */
  public postContentV2DataHandler(id: string, requestBody: string): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public deleteContentV2DataHandler(id: string, languages?: Array<string>): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/api/content/v2/data",
      query: {
   ...
   * @throws ApiError
   */
  public postContentV2TypeHandler(requestBody: ContentSource_V2): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
