...
export class WebhooksService {
   ...
   * @throws ApiError
   */
  public createWebhookHandler(requestBody: WebhookPayload): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "POST",
      url: "/api/webhooks",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public deleteWebhookHandler(id: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/api/webhooks/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public updateWebhookHandler(id: string, requestBody: WebhookPayload): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "PUT",
      url: "/api/webhooks/{id}",
      path: {
