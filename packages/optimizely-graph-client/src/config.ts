...
export function readEnvironmentVariables(): Types.OptimizelyGraphConfig {
  const config: Types.OptimizelyGraphConfig = {
    ...
    single_key: getOptional("OPTIMIZELY_GRAPH_SINGLE_KEY", () =>
      getOptional("OPTIMIZELY_CONTENTGRAPH_SINGLE_KEY", "")
    ) as string,
    gateway: getOptional("OPTIMIZELY_GRAPH_GATEWAY", () =>
...
export function applyConfigDefaults(
  ...
  config.gateway = normalizeUrl(config.gateway);
  return config;
}
