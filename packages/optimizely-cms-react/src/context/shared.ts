import type { GenericContext, TransferrableContext, BaseContext } from "./types";
...
export function isGenericContext(ctxIn?: BaseContext | null): ctxIn is GenericContext {
  return (
    typeof ctxIn == "object" &&
    ctxIn != null &&
    typeof (ctxIn as GenericContext).factory == "object" &&
    (ctxIn as GenericContext).factory != null
  );
}
