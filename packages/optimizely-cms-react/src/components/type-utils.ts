import type { GenericContext } from "../rsc";
 ...
 */
export type ElementType = React.ComponentType<any> | React.ExoticComponent<any> | keyof React.JSX.IntrinsicElements;
/**
 * Define an element as a React Component, React ExoticComponent or string name
 * representing a HTML Element (e.g. "div", "a", etc...), this value can be used
 * as first argument of React.createElement()
 ...
 */
export type ElementWithChildrenType =
  | React.ComponentType<PropsWithChildren>
  | React.ExoticComponent<PropsWithChildren>
  | keyof Omit<React.JSX.IntrinsicElements, "meta" | "img" | "video" | "audio">;

/**
 * The properties type of an ElementType
 */
export type ElementProps<T extends ElementType> = T extends keyof React.JSX.IntrinsicElements
  ? React.HTMLProps<React.JSX.IntrinsicElements[T]>
 ...
 */
export type PropTypeIfPropExists<T extends ElementType, K> = K extends keyof ElementProps<T>
  ? ElementProps<T>[K]
  : never;
