import { type ComponentTypeHandle } from "../../factory/types";
import { type EnhancedCmsComponent } from "./types";
...
export function resolveComponent(
  ...
  // Resolve component
  const Component = Utils.resolveComponentType(factory, myContentType, variant ? [variant] : []) as
    | EnhancedCmsComponent
    | undefined;
