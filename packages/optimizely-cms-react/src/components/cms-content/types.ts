...
import type { ContentLinkWithLocale, InlineContentLinkWithLocale } from "@niteco/optimizely-graph-client";
...
export type CmsContentComponentProperty = <LocalesType = string>(
  props: Partial<PropsWithContext> & CmsContentProps<LocalesType>
) => ReactNode;
