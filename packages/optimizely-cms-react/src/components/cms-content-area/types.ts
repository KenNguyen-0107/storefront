...
import type { PropsWithContext, PropsWithOptionalContext } from "../../context/types";
...
export type ItemsProperty<T extends ElementType> =
  "children" extends ElementChildrenProps<T>
    ? {
        /**
...
export type PassthroughProps<T extends ElementType, ParentKeys extends string | number | symbol> = Omit<
  ElementProps<T>,
  ParentKeys | ReservedKeys | ElementChildrenProps<T>
...
export type CmsContentAreaWrapperProps<T extends ElementType, CT extends ElementType> = {
  ...
  PassthroughProps<T, "as" | "classMapper" | "className" | "itemWrapper" | keyof CmsContentAreaCoreProps>;
...
export type CmsContentAreaItemWrapperProps<CT extends ElementType> = {
  ...
  PassthroughProps<CT, "as" | "noWrapper" | "className">;

export type CmsContentAreaProps<T extends ElementType, CT extends ElementType> = CmsContentAreaCoreProps &
  CmsContentAreaWrapperProps<T, CT>;

export type CmsContentAreaClassMapper = (
  displayOption: string,
  contentType: ContentType | null,
  index: number
) => string;

export type BaseCmsContentAreaProps<T extends ElementType, CT extends ElementType> = PropsWithCmsContent<
  PropsWithContext<CmsContentAreaProps<T, CT>>
>;

export type CmsContentAreaBaseComponent = <T extends ElementType, CT extends ElementType>(
  props: BaseCmsContentAreaProps<T, CT>
) => ReactNode;
export type CmsContentAreaComponent = <T extends ElementType, CT extends ElementType>(
  props: CmsContentAreaProps<T, CT>
) => ReactNode;
