...
import { ComponentTypeDictionary } from "../../factory/types";
import type { TextNode, TypedNode } from "./types";
import { type PropsWithOptionalContext } from "../../context/types";
 ...
 */
export function createHtmlComponent<E extends keyof React.JSX.IntrinsicElements>(
  element: E,
  ignoreChildren: boolean = false,
  defaultProps?: React.JSX.IntrinsicElements[E] & Record<string, string>
) {
  ...
  const component = ({
    ...
    ctx,
    ...props
  }: PropsWithOptionalContext<PropsWithChildren<React.JSX.IntrinsicElements[E] & { node: TypedNode }>>) => {
...
export const DefaultTextNode: FunctionComponent<PropsWithOptionalContext<{ node: TextNode }>> = ({ ctx, node }) => {
