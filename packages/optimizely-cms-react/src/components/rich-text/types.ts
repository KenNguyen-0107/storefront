...
import type { ComponentFactory } from "../../factory/types";
import type { PropsWithOptionalContext, PropsWithContext } from "../../context/types";
import type { ElementType, ElementProps, ElementWithChildrenType } from "../type-utils";
...
export type RichTextComponent = <ET extends ElementWithChildrenType>(
  props: PropsWithOptionalContext<RichTextProps<ET>>
) => ReturnType<FunctionComponent>;
export type RichTextImplProps<ET extends ElementWithChildrenType> = PropsWithContext<
  RichTextProps<ET> & Omit<ElementProps<ET>, keyof RichTextProps<ET>>
>;
 ...
 * type defined
 */
export type TypedNode = NodeWithChildren<
  Node & {
    type: string;
  } & Record<string, string | number | boolean>
>;
