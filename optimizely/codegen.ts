    ...
    "./src/gql/": {
      ...
      presetConfig: {
        ...
        injections: [
          ...
          // Commerce Components: Add Page/Experience GraphQL Files
          {
            into: "PageData",
            pathRegex: "src\/components\/commerce\/.*\.page\.graphql",
          },
          {
            into: "PageData",
            pathRegex: "src\/components\/commerce\/.*\.experience\.graphql",
          },

          // Commerce Components: Add Block/Component/Section GraphQL Files
          {
            into: "BlockData",
            pathRegex: "src\/components\/commerce\/.*\.block\.graphql",
          },
          {
            into: "BlockData",
            pathRegex: "src\/components\/commerce\/.*\.component\.graphql",
          },
          {
            into: "BlockData",
            pathRegex: "src\/components\/commerce\/.*\.section\.graphql",
          },

          // Commerce Components: Add Element GraphQL Files
          {
            into: "ElementData",
            pathRegex: "src\/components\/commerce\/.*\.element\.graphql",
          },

          // Commerce Components: Add Search GraphQL Files
          {
            into: "SearchData",
            pathRegex: "src\/components\/commerce\/.*\.search\.graphql",
          },

          // Commerce Components: Add ContentArea items
          {
            into: "IContentListItem",
            pathRegex: "src\/components\/commerce\/.*\.contentarea\.graphql",
          },
        ],
