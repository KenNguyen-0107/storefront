...
export function getSdk(
  ...
  return {
    getFooter(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getFooterQuery>({
    ...
    getBanner(
      variables: Schema.getBannerQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<Schema.getBannerQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getBannerQuery>({
    ...
    getHeader(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getHeaderQuery>({
            document: getHeaderDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
