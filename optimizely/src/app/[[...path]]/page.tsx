  ...
  factory,
  {
    ...
    client: async (token, scope) => {
      ...
      const client = createClient(undefined, token, {
        ...
        queryCache: true,
        // queryCache: process.env.NODE_ENV === "development" ? false : true,
      });
...
export const dynamic = "force-static"; // Make sure we cache pages, if one component is not static none of the routes will be static
